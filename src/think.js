...
Think.prototype = {
    onBeginContact: function(phaserBody, p2Body) {
        if (phaserBody && phaserBody.sprite.name == "head" && this.constraint === null) {
            ...
            //Create constraint between the think and the snake head that
            //it collided with. The think is then brought to the center of
            //the head sprite
            ...
            this.head.snake.think.push(this);
        }
    },
    /**
     ...
     */
    update: function() {
        //once the think reaches the center of the snake head, destroy it and
    ...
    /**
     * Destroy this think and its constraints
     */
    destroy: function() {
        if (this.head) {
            this.game.physics.p2.removeConstraint(this.constraint);
            this.sprite.destroy();
            this.head.snake.think.splice(this.head.snake.think.indexOf(this), 1);
            this.head = null;
        }
    }
};